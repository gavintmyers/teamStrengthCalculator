...
RSpec.describe HoursController, type: :controller do
  ...
  describe "GET #show" do
    it "assigns the requested hour as @hour" do
      hour = Hour.create! valid_attributes
      get :show, {:id => hour.to_param}, valid_session
  ...
  describe "GET #edit" do
    it "assigns the requested hour as @hour" do
      hour = Hour.create! valid_attributes
      get :edit, {:id => hour.to_param}, valid_session
      expect(assigns(:hour)).to eq(hour)
    end
  end
  ...
  describe "POST #create" do
    context "with valid params" do
      it "creates a new Hour" do
        expect {
          post :create, {:hour => valid_attributes}, valid_session
    ...
    context "with invalid params" do
      it "assigns a newly created but unsaved hour as @hour" do
        post :create, {:hour => invalid_attributes}, valid_session
        expect(assigns(:hour)).to be_a_new(Hour)
      end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested hour" do
        hour = Hour.create! valid_attributes
        put :update, {:id => hour.to_param, :hour => new_attributes}, valid_session
        hour.reload
      ...
      it "assigns the requested hour as @hour" do
        hour = Hour.create! valid_attributes
        put :update, {:id => hour.to_param, :hour => valid_attributes}, valid_session
        expect(assigns(:hour)).to eq(hour)
      end
    ...
    context "with invalid params" do
      it "assigns the hour as @hour" do
        hour = Hour.create! valid_attributes
        put :update, {:id => hour.to_param, :hour => invalid_attributes}, valid_session
        expect(assigns(:hour)).to eq(hour)
      end
  ...
  describe "DELETE #destroy" do
    it "destroys the requested hour" do
      hour = Hour.create! valid_attributes
      expect {
        delete :destroy, {:id => hour.to_param}, valid_session
      }.to change(Hour, :count).by(-1)
    end
